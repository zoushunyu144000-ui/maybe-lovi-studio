...
1. Product showcase
   ...
   - Featured / rotating product area on the main page
   - Individual product detail pages
2. Contact and social links
   - Location
   - Phone
   - Facebook
   - Instagram
...
- The first website version can build the brand and page framework first.
- Concept/reference-direction imagery can be used during the design stage.
